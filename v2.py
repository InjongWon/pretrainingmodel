...
# hyperparameters
batch_size = 64 
block_size = 256 # token is 256 prediciting 257 token 
max_iters = 5000 
eval_interval = 500 
learning_rate = 1e-3 
...
class Head(nn.Module):
    ...
    def forwrd(self,x):
        ...
        wel = self.dropout(wei) # dropout regularization 
...
class MultiHeadAttention(nn.Module):
    """
    Multiple heads of self attention computing in parallel
    """
    ...
    def forward(self,x):
        ...
        out = self.dropout(self.projc(out))
        return out 
