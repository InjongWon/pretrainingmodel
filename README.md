...
A from-scratch implementation of a decoder-only Transformer (GPT) in PyTorch built while studying the architecture described in *Attention Is All You Need* & *Layer Normalization* & *Attention Scheme Inspired Softmax Regression*.
